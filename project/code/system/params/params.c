...
float weight_list[5] = {-1000, -80, 0, 80, 1000}; // 权重列表
...
// 速度开环控制
const float control_without_left_vel_base_pwm = 1900.0F;  // 1800.0f;
const float control_without_right_vel_base_pwm = 2200.0F; // 2100.0f;
...
float bottom_velocity_left_pid[5] = {0.750, 0.0, 0.0, 0.50, 40.0};
// kp,ki,kd,kp2,confine
float bottom_velocity_right_pid[5] = {0.50, 0.0, 0.0, 0.50, 40.0};

float turn_angle_velocity_pid[3] = {0.0, 0.0, 0.0};
float turn_err_pid[3] = {7, 0.0, 0.0};
