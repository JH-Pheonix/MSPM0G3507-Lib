...
float weight_list[5] = {-800, -200, 0, 200, 800}; // 权重列表
...
// 速度开环控制
const float control_without_left_vel_base_pwm = 2000.0f;
const float control_without_right_vel_base_pwm = 1500.0f;
const int control_without_vel_turn_delay = 30;     // 持续时间，可根据实际调整
...
float turn_err_pid[3] = {2.0, 0.0, 0.0};
