...
#define MOTOR_RIGHT PWM_TIM_G7_CH0_B15
#define MOTOR_RIGHT_DIR B16
#define MOTOR_LEFT PWM_TIM_A0_CH0_A0
#define MOTOR_LEFT_DIR A1

#define MOTOR_DRIVER_LEFT_PWM PWM_TIM_A0_CH1_B9
#define MOTOR_DRIVER_LEFT_IN1 B3
#define MOTOR_DRIVER_LEFT_IN2 B13
#define MOTOR_DRIVER_RIGHT_PWM PWM_TIM_A0_CH0_B8
#define MOTOR_DRIVER_RIGHT_IN1 B2
#define MOTOR_DRIVER_RIGHT_IN2 B12
