...
static encoder_interrupt_state_t int_encoders[ENCODER_CNT];
...
static encoder_data_t encoder_data[ENCODER_CNT];
static encoder_state_t encoder_state[ENCODER_CNT];
